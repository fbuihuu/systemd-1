...
int bus_cgroup_set_property(
        ...
        if (streq(name, "CPUAccounting")) {
                ...
                if (mode != UNIT_CHECK) {
                        ...
                        if (weight == CGROUP_WEIGHT_INVALID)
                                ...
                                unit_write_drop_in_private_format(u, mode, name, "%s=%" PRIu64, name, weight);
                }
                ...
                if (mode != UNIT_CHECK) {
                        ...
                        if (shares == CGROUP_CPU_SHARES_INVALID)
                                ...
                                unit_write_drop_in_private_format(u, mode, name, "%s=%" PRIu64, name, shares);
                }
        ...
        if (u->transient && u->load_state == UNIT_STUB)
                return bus_cgroup_set_transient_property(u, c, name, message, mode, error);
